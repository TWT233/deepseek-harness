...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/cli-app': { kind: 'indirect', reason: 'The app records policy events consumed by sandbox and approval plugins; it registers no prompt or tool schema.' },
